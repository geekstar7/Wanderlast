        ...
        <nav className="hidden md:flex items-center space-x-8">
          {navItems.map((item) => (
            <Link
              ...
              to={item.href}
              className={cn(
                "text-foreground hover:text-travel-teal transition-colors font-medium",
                location.pathname === item.href && "text-travel-teal"
              )}
            >
              {item.name}
            </Link>
          ...
          <nav className="space-y-2">
            {navItems.map((item) => (
              <Link
                ...
                to={item.href}
                className={cn(
                  "block py-2 text-foreground hover:text-travel-teal transition-colors font-medium",
                  location.pathname === item.href && "text-travel-teal"
                )}
